...
const DeteksiSection: React.FC = () => {
  ...
  return (
    <section className='bg-white text-gray-800 font-poppins flex flex-col min-h-screen'>
      <Navbar style='dark' />
      <div className='text-center mx-auto px-4 sm:px-6 lg:px-0 max-w-[1000px] py-20 lg:py-26'>
        ...
        <div className='flex flex-col items-center justify-center gap-4 my-10 sm:my-14'>
          <div className='relative w-40 h-40 sm:w-48 sm:h-48'>
            {[
              ...
              <div
                key={i}
                className={`absolute ${pos} w-10 h-10 sm:w-12 sm:h-12`}
              >
                <div
                  className={`
          ...
          <label
            htmlFor='fileUpload'
            className='mt-8 text-sm sm:text-base text-[#222] cursor-pointer'
          >
            atau upload gambar{' '}
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 py-8 px-6 sm:px-7 rounded-2xl bg-white shadow-lg'>
          <StepComponent
            description='Ambil foto daun atau bagian tanaman.'
            icon={<Camera />}
          />
          <StepComponent
            description='Sistem kami menganalisis gambar secara otomatis.'
            icon={<RefreshCcw />}
          />
          <StepComponent
